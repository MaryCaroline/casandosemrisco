...
- [ ] Add an email address to the `ADMINS` settings variable in `casandosemrisco/casandosemrisco/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `casandosemrisco/casandosemrisco/settings/production.py`
...
- Create a copy of ``casandosemrisco/settings/local.py.example``:  
  `cp casandosemrisco/settings/local.py.example casandosemrisco/settings/local.py` (remembering you should replace `casandosemrisco` with your project's name!).
